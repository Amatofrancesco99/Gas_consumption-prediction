...
sd1Val=sqrt(SSR1Val/(length(n)+length(nVal)));
...
%Standard deviation calculation
sd2Val=sqrt(SSR2Val/(length(n)+length(nVal)));
...
%Standard deviation calculation
sd3Val=sqrt(SSR3Val/(length(n)+length(nVal)));
...
%Standard deviation calculation
sd4Val=sqrt(SSR4Val/(length(n)+length(nVal)));
